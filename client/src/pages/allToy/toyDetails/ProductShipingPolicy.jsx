...
const ProductShipingPolicy = () => {
  return (
    <>
      <div className="text-blue-gray-600">
        <h4 className="font-semibold text-blue-gray-900">Returns Policy</h4>
        <p className="mb-2">
        ...
        <p className="mb-2">
          ...
          click the Return Item button. We'll notify you via e-mail of your
          refund once we've received and processed the returned item.
        </p>
      </div>
      <div className="text-blue-gray-600">
        <h4 className="font-semibold text-blue-gray-900">Shipping</h4>
        <p className="mb-2">
...
export default ProductShipingPolicy;
