...
const WhitelistButton = ({item}) => {
    ...
    const [whitelist,refetch] = useWhitelist()
  ...
  return (
    <div>
      <button onClick={()=>handleWhitelist(item)} className={ listedBgColorChang ? `rounded-full p-1 flex items-center justify-center  border border-blue-gray-100 mb-1 bg-pink-300 text-white transition-all duration-500` : `rounded-full p-1 flex items-center justify-center bg-white border border-blue-gray-100 mb-1 hover:bg-pink-300 hover:text-white transition-all duration-500`}>
